...
type StudentsServiceClient interface {
	...
	DeleteStudents(ctx context.Context, in *StudentIds, opts ...grpc.CallOption) (*DeleteStudentConfirmation, error)
}
...
func (c *studentsServiceClient) GetStudents(ctx context.Context, in *GetStudentRequest, opts ...grpc.CallOption) (*Students, error) {
...
func (c *studentsServiceClient) DeleteStudents(ctx context.Context, in *StudentIds, opts ...grpc.CallOption) (*DeleteStudentConfirmation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteStudentConfirmation)
...
type StudentsServiceServer interface {
	...
	DeleteStudents(context.Context, *StudentIds) (*DeleteStudentConfirmation, error)
...
func (UnimplementedStudentsServiceServer) GetStudents(context.Context, *GetStudentRequest) (*Students, error) {
...
func (UnimplementedStudentsServiceServer) DeleteStudents(context.Context, *StudentIds) (*DeleteStudentConfirmation, error) {
...
func _StudentsService_GetStudents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentsServiceServer).GetStudents(ctx, req.(*GetStudentRequest))
	}
