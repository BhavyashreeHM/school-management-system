...
const (
	...
	TeachersService_GetStudentsByClassTeachers_FullMethodName      = "/main.TeachersService/GetStudentsByClassTeachers"
	TeachersService_GetStudentsCountByClassTeachers_FullMethodName = "/main.TeachersService/GetStudentsCountByClassTeachers"
)
...
type TeachersServiceClient interface {
	...
	DeleteTeachers(ctx context.Context, in *TeacherIds, opts ...grpc.CallOption) (*DeleteteacherConfirmation, error)
	GetStudentsByClassTeachers(ctx context.Context, in *TeacherIds, opts ...grpc.CallOption) (*Students, error)
	GetStudentsCountByClassTeachers(ctx context.Context, in *TeacherIds, opts ...grpc.CallOption) (*StudentCount, error)
}
...
func (c *teachersServiceClient) GetTeachers(ctx context.Context, in *GetTeacherRequest, opts ...grpc.CallOption) (*Teachers, error) {
...
func (c *teachersServiceClient) DeleteTeachers(ctx context.Context, in *TeacherIds, opts ...grpc.CallOption) (*DeleteteacherConfirmation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteteacherConfirmation)
...
func (c *teachersServiceClient) GetStudentsByClassTeachers(ctx context.Context, in *TeacherIds, opts ...grpc.CallOption) (*Students, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Students)
	err := c.cc.Invoke(ctx, TeachersService_GetStudentsByClassTeachers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *teachersServiceClient) GetStudentsCountByClassTeachers(ctx context.Context, in *TeacherIds, opts ...grpc.CallOption) (*StudentCount, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StudentCount)
	err := c.cc.Invoke(ctx, TeachersService_GetStudentsCountByClassTeachers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TeachersServiceServer interface {
	...
	DeleteTeachers(context.Context, *TeacherIds) (*DeleteteacherConfirmation, error)
	GetStudentsByClassTeachers(context.Context, *TeacherIds) (*Students, error)
	GetStudentsCountByClassTeachers(context.Context, *TeacherIds) (*StudentCount, error)
...
func (UnimplementedTeachersServiceServer) GetTeachers(context.Context, *GetTeacherRequest) (*Teachers, error) {
...
func (UnimplementedTeachersServiceServer) DeleteTeachers(context.Context, *TeacherIds) (*DeleteteacherConfirmation, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteTeachers not implemented")
}
func (UnimplementedTeachersServiceServer) GetStudentsByClassTeachers(context.Context, *TeacherIds) (*Students, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStudentsByClassTeachers not implemented")
}
func (UnimplementedTeachersServiceServer) GetStudentsCountByClassTeachers(context.Context, *TeacherIds) (*StudentCount, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStudentsCountByClassTeachers not implemented")
}
...
func _TeachersService_GetTeachers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeachersServiceServer).GetTeachers(ctx, req.(*GetTeacherRequest))
	}
...
func _TeachersService_GetStudentsByClassTeachers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TeacherIds)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeachersServiceServer).GetStudentsByClassTeachers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeachersService_GetStudentsByClassTeachers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeachersServiceServer).GetStudentsByClassTeachers(ctx, req.(*TeacherIds))
	}
	return interceptor(ctx, in, info, handler)
}

func _TeachersService_GetStudentsCountByClassTeachers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TeacherIds)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeachersServiceServer).GetStudentsCountByClassTeachers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeachersService_GetStudentsCountByClassTeachers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeachersServiceServer).GetStudentsCountByClassTeachers(ctx, req.(*TeacherIds))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeachersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStudentsByClassTeachers",
			Handler:    _TeachersService_GetStudentsByClassTeachers_Handler,
		},
		{
			MethodName: "GetStudentsCountByClassTeachers",
			Handler:    _TeachersService_GetStudentsCountByClassTeachers_Handler,
		},
	},
